...
```YAML
postgresql_exporter_version: 0.20.1
```
...
```YAML
postgresql_version: "{{ '14' if ansible_facts['distribution_version'] is version('20.04', '>') else ('12' if ansible_facts['distribution_version'] is version('18.04', '>') else '10') }}"
```
